...
class Back(QtCore.QThread, rectangle_grid.pc):
    ...
    def __del__(self):
        self.emit(QtCore.SIGNAL("update(QString)"),"Done")
        self.wait()
    ...
    def run(self):
        """function wrapper, formerly heat_load_matrix()"""
        #never called directly, called by qt
