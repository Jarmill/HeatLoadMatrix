...
class Back(rectangle_grid.pc):
    ...
    def heat_load_matrix(self):
        ...
        error=integrated_power_after_filtering-total_integrated_absorbed_power-integrated_power_after_region
        error_p=error/integrated_power_after_filtering*100
        s+="Integrated power error: "+str(error)+ " W\n"
        s+="Integrated power error percentage: "+str(error_p)+"%\n"
